      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Sterk</a>
          </div>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
            <h2 class="text-left"><? echo $message ?></h2>
          
              <br>
              
               <a href="addUser.php" class="btn btn-info">Add user</a>   
               <a href="" class="btn btn-warning">show users</a> 
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-9 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <a href="allBookings.php" class="btn btn-outline-warning">All bookings</a>
                  <br>
                  <h4 class="card-title">Recent Bookings</h4>
                  <p class="card-category">Showing bookings from:</p>
                </div>
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-dark/examples/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jan 2022 08:03:12 GMT -->
</html>
