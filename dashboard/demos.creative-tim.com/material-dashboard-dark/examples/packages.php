            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <h4 class="card-title ">Packages List
                  </h4>
                  
                  <p class="card-category"> Here is the list of all packages and details</p>
                </div>
                <div class="col-3"> <a class="btn btn-warning" href="add_package.php">Add A new package</a></div>
...
<tr>
  ...
  <td><a class="btn btn-danger " href="delete.php?id=<?=$val['package_id']?>&req=delete">DELETE</a>
  <a class="btn btn-warning" href="edit.php?id=<?=$val['package_id']?>">EDIT</a>
</tr>
<?
}
